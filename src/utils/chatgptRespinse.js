...
export const imageChatgptResponse = async (imageText, allergies, medicalHistory) => {
    if (!imageText) {
        throw new ApiError(400, "No image text provided");
    }

    const prompt = generateDynamicPromptForImage(imageText, allergies, medicalHistory);
...
const generateDynamicPromptForImage = (imageText, allergies, medicalHistory) => {
